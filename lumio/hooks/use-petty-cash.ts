...
export function usePettyCashFunds(status?: string, department?: string) {
    ...
    return useQuery({
        ...
        queryFn: () => fetcher(`/api/petty-cash/funds?${params.toString()}`)
    })
}
...
export function usePettyCashExpenses(fundId?: string, status?: string, settlementId?: string) {
    ...
    return useQuery({
        ...
        queryFn: () => fetcher(`/api/petty-cash/expenses?${params.toString()}`)
    })
}
...
export function usePettyCashSettlements(fundId?: string, status?: string) {
    ...
    return useQuery({
        ...
        queryFn: () => fetcher(`/api/petty-cash/settlements?${params.toString()}`)
    })
}
...
export function usePettyCashReplenishments(fundId?: string, status?: string) {
    ...
    return useQuery({
        ...
        queryFn: () => fetcher(`/api/petty-cash/replenishments?${params.toString()}`)
    })
}
...
export function useCreatePettyCashReplenishment() {
    ...
    return useMutation({
        mutationFn: async (replenishmentData: any) => {
...
export function usePettyCashAudits(fundId?: string, auditType?: string) {
    ...
    return useQuery({
        ...
        queryFn: () => fetcher(`/api/petty-cash/audits?${params.toString()}`)
    })
}
