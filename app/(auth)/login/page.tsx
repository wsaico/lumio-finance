        ...
        <Card className="border-border/50 shadow-xl shadow-primary/5 backdrop-blur-sm">
            ...
            <CardFooter className="flex flex-col gap-2 text-center text-sm text-muted-foreground">
                <p>
                    ...
                    <Link href="/register" className="text-primary hover:underline font-medium decoration-primary/30 underline-offset-4">
                        Regístrate aquí
                    </Link>
                </p>
                <Link href="/forgot-password" className="hover:text-foreground transition-colors text-xs">
